...
const CHAPTERS = [
  ...
  // ============== CHƯƠNG (mới) — Luyện Khí: Cơ Duyên Tao Ngộ ==============
  {
    ...
    scenes: [
      ...
      L('npc', '"Cứ chịu khó bôn ba — **cơ duyên không cầu mà tới**! Cứ tu luyện, bế quan hay đi săn yêu, đôi khi **Kỳ Ngộ tự ập tới**. Mỗi cơ duyên là một lựa chọn: gan dạ thì lời to, mà cũng có khi xui xẻo. Cứ thử một phen cho biết!"'),
      T({ type: 'kyngo', goal: 1 }, 'Trải qua **1 kỳ ngộ** — cứ tu luyện / bế quan / săn yêu, kỳ ngộ sẽ **tự ập tới ngẫu nhiên**. *(Bấm "Kiểm tra tiến độ" sau đó.)*', { micro: { tuVi: 30 } }),
  ...
  // ============== CHƯƠNG 5 — Nguyên Anh: Xuất Khiếu ==============
  {
    ...
    npc: { name: 'Ngự Thú Sư Lạc Dao', emoji: '🐉' },
    scenes: [
      L('narrator', 'Một thiếu nữ áo xanh cưỡi linh điêu đáp xuống, sau lưng lốc nhốc đủ loại yêu thú ngoan ngoãn đi theo — Ngự Thú Sư Lạc Dao, bậc thầy thu phục linh thú nức tiếng.'),
      L('npc', '"Kim Đan đỉnh phong rồi à? Kết được **Nguyên Anh**, nguyên thần ngươi sẽ đủ mạnh để **giao cảm với yêu thú**, thu phục chúng làm **bạn chiến**." — nàng vỗ về con điêu. "Có thú đồng hành, vào sinh ra tử nơi bí cảnh sẽ bớt cô độc — chúng cộng sức cho ngươi, đôi khi còn tung đòn hiểm thay ngươi."'),
      C('Đạo hữu đáp lời Lạc Dao?', [
        ['Ta muốn một mãnh thú dũng mãnh!', '"Ta muốn một con thú thật lợi hại!" — đạo hữu hào hứng.'],
        ['Thu phục thú có khó không?', '"Thu phục yêu thú… có khó lắm không ạ?" — đạo hữu tò mò.'],
      ]),
      L('npc', '"Cứ kết Nguyên Anh trước đã, chuyện ngự thú để ta lo. Lên được cảnh giới đó, tới **Ngự Thú Viên** chọn cho mình một con bạn chiến!"'),
      T({ type: 'reach_realm', realm: 4, goal: 1 }, 'Tu luyện & độ kiếp cho tới khi kết thành **👶 Nguyên Anh**.'),
      L('npc', '"HA! Nguyên Anh xuất khiếu rồi! Từ nay ngươi có thể tới **Ngự Thú Viên** thu phục yêu thú làm bạn chiến — nuôi nó, luyện cấp, rồi dắt vào bí cảnh cùng tung hoành!" — Lạc Dao mỉm cười, con linh điêu kêu vang một tiếng chào mừng.'),
      L('narrator', '_(Mở khóa **🐉 Ngự Thú**: thu phục yêu thú làm bạn chiến PvE — cộng chỉ số + tung đòn phụ. Mở ở kênh **Ngự Thú Viên**.)_'),
    ],
  ...
  // ============== CHƯƠNG 6 — Hóa Thần: Nhập Tông Lập Phái ==============
  {
    ...
    scenes: [
      ...
      L('npc', '"Tuyệt diệu! Một thân Hóa Thần, đạo hữu nay là bậc cao thủ trấn phái." — Vân Hạc chắp tay. "Hóa Thần là **luyện thần** — Nguyên Thần ngươi đã đủ mạnh để khai mở **Thần Thông**. Tới **Nguyên Thần Điện** (hoặc Hồ Sơ) mà tu luyện Nguyên Thần, mở các thần thông nghịch thiên — dùng được cả khi luận võ!"'),
      L('narrator', '_(Mở khóa **👁️ Thần Thông**: tu Nguyên Thần lên cấp để mở & vận các Thần Thông cộng chỉ số — áp cả PvE lẫn PvP.)_'),
  ...
  // ============== CHƯƠNG 7 — Luyện Hư: Phá Hư Kiến Đạo ==============
  {
    ...
    scenes: [
      ...
      L('npc', '"Hảo! Thần hồn ngươi đã bắt đầu hòa vào hư không. Thần hồn đã thông hư không thì **Nguyên Thần có thể xuất khiếu** — rời thân đi **Du Tiên** lịch luyện vùng xa, dù thân xác ngươi đang tĩnh tu." — Hư Cảnh Chân Nhân chỉ tay về **Du Tiên Đường**. "Cứ sai Nguyên Thần lên đường, lát sau nó mang cơ duyên về cho ngươi."'),
      L('narrator', '_(Mở khóa **🧭 Du Tiên** — Nguyên Thần Xuất Khiếu: hướng chơi idle, sai Nguyên Thần đi vài giờ rồi thu nguyên liệu hiếm + linh thạch + cơ duyên, kể cả khi offline.)_'),
    ],
