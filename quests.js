...
const DAILIES = [
  ...
  { id: 'd_sanyeu',  emoji: '🐗', name: 'Trừ Yêu Vệ Đạo',      type: 'sanyeu',       goal: 3,  minRealm: 1, feature: 'sanyeu',      reward: { tuVi: 50, stones: 15 }, desc: 'Săn hạ 3 yêu hoang ở Bãi Săn Yêu.' },
  ...
  { id: 'd_dauphap', emoji: '⚔️', name: 'Luận Võ Tranh Phong', type: 'pvp_win',      goal: 1,  minRealm: 2, feature: 'dauphap',     reward: { tuVi: 90, stones: 25 }, desc: 'Thắng 1 trận Đấu Pháp ở Luận Võ Đài.' },
];
